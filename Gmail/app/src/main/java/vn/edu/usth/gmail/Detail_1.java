...
public class Detail_1 extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = emailList.get(position).getName();
        String headMail = emailList.get(position).getHead_mail();
        ...
        public void onSwipeRight() {
            ...
            if (currentIndex[0] > 0) {
                ...
                Dname.setText(emailList.get(currentIndex[0]).getName());
                DheadMail.setText(emailList.get(currentIndex[0]).getHead_mail());
